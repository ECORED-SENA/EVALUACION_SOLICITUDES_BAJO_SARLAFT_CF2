      ...
      .row.titulo-prin(numero="8" titulo="Políticas sobre la modificación del manual ")
        ...
        .col-8
          ...
          ul.lista-ul.mt-3
            ...
            li 
              i.fas.fa-angle-right.acento-contenido
              | Este manual debe ser actualizado de acuerdo con las necesidades de la Fiduciaria, y estas modificaciones deben ser avaladas por la Junta Directiva, con la periodicidad que cada entidad haya definido en su política.
            li 
              i.fas.fa-angle-right.acento-contenido
